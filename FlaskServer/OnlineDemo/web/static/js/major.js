...
.defer(d3.csv, "{{url_for('static', filename='dataSet/characters.csv')}}")
...
function selectPerson(d){
  ...
  //console.log(current_selected_person);
  // console.log(d);
  d3.csv("{{url_for('static', filename='dataSet/people_spell.csv')}}",function(error,data) {
...
d3.csv("{{url_for('static', filename='dataSet/spells.csv')}}",parseSpellsData,function(error,data) {
  spells_data = data;

});

d3.csv("{{url_for('static', filename='dataSet/spell_sum.csv')}}",parseSpellSumData,function(error,data) {
  spell_sum_data = data;
...
function plotdata() {
  ...
  d3.csv("{{url_for('static', filename='dataSet/trend.csv')}}", function (error, rawData) {
    if (error) {
      console.error(error);
      return;
    }
    ...
    // get markers_data
    d3.json("{{url_for('static', filename='dataSet/markers.json')}}", function (error, markerData) {
      if (error) {
        console.error(error);
        return;
      }
